...
module.exports = function (content, sourceMap) {
  ...
  if (!this.resourceQuery) {
    ...
    if (imports.length) {
      ...
      newContent += 'component.exports.extendOptions.components = component.exports.extendOptions.components || {}\n'
      components.forEach(c => {
        newContent += `component.exports.extendOptions.components['${c}'] = component.exports.extendOptions.components['${c}'] || ${c}\n`
      })
